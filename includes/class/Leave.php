<?php 
	...
	class Leave{
        ...
        function setLeaveData($leaveDataArr){ $this->LeaveData = $leaveDataArr; }
        function setLeaveTypeData($leaveTypeDataArr){ $this->LeaveTypeData = $leaveTypeDataArr; }
        ...
        public function getCurrentLeaveBalance($employee_id, $leave_type_id, $date = null) {
            ...
            if (!$lt_result || $lt_result->num_rows == 0) return null;
            ...
            if (!$elb_result || $elb_result->num_rows == 0) return null;
