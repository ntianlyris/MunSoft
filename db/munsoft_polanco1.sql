...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 23, 2025 at 07:53 PM
...
CREATE TABLE `signatories` (
  ...
  `role` enum('HEAD','MAYOR','TREASURER','ACCOUNTANT','DISBURSING') DEFAULT NULL,
...
--
ALTER TABLE `signatories`
  ADD CONSTRAINT `signatories_ibfk_1` FOREIGN KEY (`dept_id`) REFERENCES `departments_tbl` (`dept_id`);
COMMIT;
