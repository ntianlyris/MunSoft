...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2025 at 09:55 AM
...
(50, 53, 27, 1000.55, '2025-11-01'),
(51, 54, 63, 20000.00, '2025-11-01'),
(52, 54, 64, 2000.00, '2025-11-01');
...
(53, 11, 15, 17, 3, 60000.00, 74000.00, 1000.55, 36499.73, '[{\"earning_comp_id\":\"40\",\"label\":\"Sal-Reg\",\"amount\":60000},{\"earning_comp_id\":\"41\",\"label\":\"PERA\",\"amount\":2000},{\"earning_comp_id\":\"42\",\"label\":\"RA\",\"amount\":6000},{\"earning_comp_id\":\"43\",\"label\":\"TA\",\"amount\":6000}]', '[{\"deduct_comp_id\":\"27\",\"label\":\"LR_INS\",\"amount\":1000.55}]', '[{\"emp_govshare_id\":\"22\",\"label\":\"L_R\",\"amount\":7200},{\"emp_govshare_id\":\"23\",\"label\":\"HDMF\",\"amount\":200},{\"emp_govshare_id\":\"24\",\"label\":\"PHIC\",\"amount\":1500},{\"emp_govshare_id\":\"21\",\"label\":\"ECC\",\"amount\":100}]', '2025-11-01 08:20:50', '2025-11-01 08:20:50'),
(54, 8, 16, 17, 3, 70000.00, 85600.00, 22000.00, 31800.00, '[{\"earning_comp_id\":\"44\",\"label\":\"Sal-Reg\",\"amount\":70000},{\"earning_comp_id\":\"45\",\"label\":\"PERA\",\"amount\":2000},{\"earning_comp_id\":\"46\",\"label\":\"RA\",\"amount\":6800},{\"earning_comp_id\":\"47\",\"label\":\"TA\",\"amount\":6800}]', '[{\"deduct_comp_id\":\"63\",\"label\":\"W_TAX\",\"amount\":20000},{\"deduct_comp_id\":\"64\",\"label\":\"PHIC-PREM\",\"amount\":2000}]', '[{\"emp_govshare_id\":\"18\",\"label\":\"L_R\",\"amount\":8400},{\"emp_govshare_id\":\"19\",\"label\":\"HDMF\",\"amount\":200},{\"emp_govshare_id\":\"20\",\"label\":\"PHIC\",\"amount\":1750},{\"emp_govshare_id\":\"17\",\"label\":\"ECC\",\"amount\":100}]', '2025-11-01 08:20:50', '2025-11-01 08:20:50');
...
(45, 53, 22, 7200.00, '2025-11-01'),
(46, 53, 23, 200.00, '2025-11-01'),
(47, 53, 24, 1500.00, '2025-11-01'),
(48, 53, 21, 100.00, '2025-11-01'),
(49, 54, 18, 8400.00, '2025-11-01'),
(50, 54, 19, 200.00, '2025-11-01'),
(51, 54, 20, 1750.00, '2025-11-01'),
(52, 54, 17, 100.00, '2025-11-01');
...
CREATE TABLE `signatories` (
  ...
  `role_type` enum('HEAD','MAYOR','TREASURER','ACCOUNTANT','DISBURSING') DEFAULT NULL,
  `dept_id` int(11) NOT NULL,
  `report_type` enum('PAYROLL','REMITTANCE','JOURNAL','') NOT NULL,
...
(8, 'PROSERPHINE G. GODINEZ, CPA', 'Municipal Accountant', 'HEAD', 7, 'PAYROLL', '1', 'CERTIFIED: Services have been duly rendered as stated', '2025-11-01 15:15:57', NULL, 1);
...
--
ALTER TABLE `payroll_deductions`
  MODIFY `payroll_deduction_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;

--
-- AUTO_INCREMENT for table `payroll_entries`
--
ALTER TABLE `payroll_entries`
  MODIFY `payroll_entry_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `payroll_govshares`
  MODIFY `payroll_govshare_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
