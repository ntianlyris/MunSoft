...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2026 at 07:36 PM
...
CREATE TABLE `payroll_entries` (
  ...
  `status` enum('DRAFT','SUBMITTED','APPROVED','PAID','LOCKED') DEFAULT 'DRAFT' COMMENT 'Payroll workflow status - controls edit/delete permissions',
...
--
ALTER TABLE `payroll_deductions`
  MODIFY `payroll_deduction_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1160;

--
-- AUTO_INCREMENT for table `payroll_entries`
--
ALTER TABLE `payroll_entries`
  MODIFY `payroll_entry_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
